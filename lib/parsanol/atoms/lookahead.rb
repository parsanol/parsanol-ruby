...
class Parsanol::Atoms::Lookahead < Parsanol::Atoms::Base
  ...
  def initialize(parser, is_positive = true)
    ...
    @should_start = ["Input should start with ".freeze, parser].freeze
    @should_not_start = ["Input should not start with ".freeze, parser].freeze
  end
  ...
  def try(source, context, consume_all)
    ...
    matched, _ = @bound_parslet.apply(source, context, consume_all)
